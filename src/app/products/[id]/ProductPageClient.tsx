    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
          <button onClick={() => router.push('/')} className="hover:text-[#43abc3]">
            Home
          </button>
          <ChevronRight className="h-4 w-4" />
          <button onClick={() => router.push('/#products')} className="hover:text-[#43abc3]">
            Products
          </button>
          <ChevronRight className="h-4 w-4" />
                  ...
                  {product.images.map((imageUrl, imageIndex) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-colors ${
                        imageIndex === selectedImageIndex ? 'bg-white' : 'bg-white/50'
                      }`}
          ...
          <div>
            ...
            <div className="mb-6">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <Badge variant="outline" className="mb-3">{product.brand}</Badge>
                ...
                <div className="flex gap-2 ml-4">
                  <Button
                    ...
                    className={inWishlist ? 'bg-red-50 text-red-600 border-red-200' : ''}
                  >
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className={`font-medium ${product.inStock ? 'text-green-700' : 'text-red-700'}`}>
                  {product.inStock ? `In Stock (${product.stockCount ?? 0} available)` : 'Out of Stock'}
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-6 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center border border-gray-300 rounded-lg">
                    ...
                    <span className="px-6 py-2 min-w-[60px] text-center border-x border-gray-300">{quantity}</span>
                    <Button
                      variant="ghost"
                      size="sm"
            ...
            <div className="grid grid-cols-3 gap-6 mb-8 p-6 bg-gray-50 rounded-lg">
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <span className="text-sm font-medium">{product.warranty} Warranty</span>
              </div>
              <div className="flex flex-col items-center gap-2 text-center">
        ...
        <div className="mt-16">
          <Tabs defaultValue="features" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8">
              ...
              <TabsTrigger value="specs" className="text-lg py-3">Specifications</TabsTrigger>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg mb-8">
                    <div className="flex items-center gap-8">
                      <div className="text-center">
                        <div className="text-4xl font-bold text-[#43abc3] mb-2">{product.rating}</div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedProducts.map((relatedProduct) => (
                <Card key={relatedProduct.id} className="group cursor-pointer hover:shadow-lg transition-shadow duration-300">
