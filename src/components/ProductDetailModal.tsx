...
import { Star, ShoppingCart, Heart, Share2, ChevronLeft, ChevronRight, ThumbsUp, Shield, Truck, RefreshCw } from 'lucide-react';
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="text-center">
                        <div className="text-3xl font-bold text-[#43abc3]">{product.rating}</div>
