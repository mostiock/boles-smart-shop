...
export function CartSidebar() {
  const { cart, isCartOpen, toggleCart, updateQuantity, removeFromCart, clearCart } = useCart();
          ...
          {cart.items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">Add some smart devices to get started!</p>
            ...
            <>
              ...
              <div className="py-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="ghost" onClick={toggleCart} className="w-full">
                    Continue Shopping
                  </Button>
                </div>
